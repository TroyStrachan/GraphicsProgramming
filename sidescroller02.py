...
02: getting scrolling back ground to work. bg is 2880px wide - issue, once it gets to the end it doesn't repeat. just blurs.
03 expectation: get a fore ground to cover the character as he walks
@author: Troy
'''
...
class Link(pygame.sprite.Sprite):
    ...
    def update(self):
# working on getting comtrol of the character        
...
class Background(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("Landscape-with-treeslong.png")
        self.image = self.image.convert()
        self.rect = self.image.get_rect()
        self.dx = -2
        self.reset()
